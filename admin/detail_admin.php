...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <!-- Sidebar - Brand -->
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="d_admin.php">
            ...
            <li class="nav-item">
            <li class="nav-item">
                <a class="nav-link" href="laporan_menunggu.php">
                    <i class="fas fa-table"></i>
                    <span>Laporan Masih Menunggu</span></a>
            </li>

            <li class="nav-item">
                <a class="nav-link" href="laporan_diterima.php">
                    <i class="fas fa-table"></i>
                    <span>Laporan Sudah Diteruskan</span></a>
            </li>
            <li class="nav-item">
                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-12 col-md-6 mb-4">
                            <div class="card border-left-primary shadow h-100 py-2">
                                ...
                                <?php 
                                    require '../koneksi.php';
                                     $sql=mysqli_query($conn,"SELECT * FROM user WHERE id_user='$_GET[id]' ");
                                     ...
                                     <form action="update_admin.php" method="POST">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control form-control-user" id="judul"
                                                name="id" value="<?php echo $data['id_user']; ?>">
                                        </div>
                                    <form action="update_admin.php" method="POST">
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            <label for="">NIK</label>
                                            <input type="text" class="form-control form-control-user" id="judul"
                                                name="nik" value="<?php echo $data['nik']; ?>" readonly>
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div style="justify-content: center; align-items: center;"
                                                class="text-center">
                                                <input type="submit" value="Ubah" name="" class="btn-primary"
