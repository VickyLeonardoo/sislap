...
?>
 <?php 
        ...
        require '../../koneksi.php';
            $sql=mysqli_query($conn,"SELECT * FROM pengaduan WHERE status='teruskan' and unit='UPT SI'");
...
<?php 
        ...
        require '../../koneksi.php';
            $sql=mysqli_query($conn,"SELECT * FROM pengaduan WHERE status='selesai' and unit='UPT SI'");
            if($cek=mysqli_num_rows($sql))
            {
