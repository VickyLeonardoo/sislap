...
?>
 <?php 
        ...
        require '../../koneksi.php';
            $sql=mysqli_query($conn,"SELECT * FROM pengaduan WHERE status='teruskan' and unit='SPI'");
...
<?php 
        ...
        require '../../koneksi.php';
            $sql=mysqli_query($conn,"SELECT * FROM pengaduan WHERE status='selesai' and unit='SPI'");
            if($cek=mysqli_num_rows($sql))
            {
