...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item">
            <li class="nav-item">
                <a class="nav-link" href="p2m/laporan_p2m.php">
                    <i class="fas fa-table"></i>
                    <span>Laporan Masuk</span></a>
            </li>

            <li class="nav-item">
                <a class="nav-link" href="p2m/laporan_selesai.php">
                    <i class="fas fa-table"></i>
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        ...
                        <?php include 'p2m/halaman_p2m.php';?>
            ...
            <div class="modal fade" id="logoutModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-bhaody">Select "Logout" below if you are ready to end your current session.
                        </div>
