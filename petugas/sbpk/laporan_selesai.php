<div class="col-xl-12 col-md-6 mb-4">
                            <div class="card border-left-primary shadow h-100 py-2">
                                ...
                                <?php 
                                    ...
                                    $hasil= mysqli_query($conn,"SELECT * from pengaduan where status='Selesai' and unit='SBPK'");
                                ...
                                <table class="table">
                                        ...
                                        $no=1;
                                        require '../../koneksi.php';
                                        $sql = mysqli_query($conn,"SELECT * from pengaduan where status='Selesai' and unit='SBPK' order by no asc limit $awalData,$jumlahDataPerHalaman");
