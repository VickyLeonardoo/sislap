...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <!-- Sidebar - Brand -->
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="upt_si.php">
            ...
            <li class="nav-item active">
                <a class="nav-link" href="upt_si.php">
            ...
            <li class="nav-item">
            <li class="nav-item">
                <a class="nav-link" href="si/laporan_si.php">
