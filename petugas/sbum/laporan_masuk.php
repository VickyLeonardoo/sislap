...
<div class="col-xl-12 col-md-6 mb-4">
                            <div class="card border-left-primary shadow h-100 py-2">
                                ...
                                <?php 
                                    ...
                                    $hasil= mysqli_query($conn,"SELECT * from pengaduan where status='teruskan' and unit='SBUM'");
                                ...
                                <table class="table">
                                        ...
                                        $no=1;
                                        require '../../koneksi.php';
                                        $sql = mysqli_query($conn,"SELECT * from pengaduan where status='teruskan' and unit='SBUM' order by no asc limit $awalData,$jumlahDataPerHalaman");
