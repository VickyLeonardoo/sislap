...
?>
 <?php 
        ...
        require '../../koneksi.php';
            $sql=mysqli_query($conn,"SELECT * FROM pengaduan WHERE status='teruskan' and unit='UPT PP'");
...
<?php 
        ...
        require '../../koneksi.php';
            $sql=mysqli_query($conn,"SELECT * FROM pengaduan WHERE status='selesai' and unit='UPT PP'");
            if($cek=mysqli_num_rows($sql))
            {
