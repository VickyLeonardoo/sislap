...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <!-- Sidebar - Brand -->
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="../sbpk.php">
            ...
            <li class="nav-item active">
                <a class="nav-link" href="../sbpk.php">
            ...
            <li class="nav-item">
            <li class="nav-item">
                <a class="nav-link" href="laporan_sbpk.php">
                        ...
                        <div class="col-xl-12 col-md-6 mb-4">
                            <div class="card border-left-primary shadow h-100 py-2">
                                ...
                                <table class="table">
                                        ...
                                        $i = 1;
                                        require '../../koneksi.php';
                                        $sql = mysqli_query($conn,"SELECT * from pengaduan where status='teruskan' and unit='SBPK'");
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="detail_sbpk.php?no=<?php echo $data['no']; ?>" class="btn btn-info btn-icon-split">
