...
<body id="page-top">
    ...
    <div id="wrapper">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            ...
                            <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in"
                                ...
                                <a class="dropdown-item" href="data_unit.php">
        ...
        require '../koneksi.php';
            $sql=mysqli_query($conn,"SELECT * FROM user WHERE level != 'Masyarakat' and level != 'Admin'");
     ...
     <?php 
        ...
        require '../koneksi.php';
            $sql=mysqli_query($conn,"SELECT * FROM pengaduan where status='selesai' ");
            if($cek=mysqli_num_rows($sql))
            {
