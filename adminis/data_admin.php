        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <form action="POST">
                        ...
                        <br>
                        <br>
                <a href="tambah_admin.php" class="btn btn-primary btn-icon-split">
                        ...
                        <div class="col-xl-12 col-md-6 mb-4">
                            <div class="card border-left-primary shadow h-100 py-2">
                                ...
                                error_reporting(0);
                                    ...
                                    $hasil= mysqli_query($conn,"SELECT * from user where level = 'Admin'");
                                ...
                                <tfoot>
                                        ...
                                        if($carii != ''){
                                            ...
                                            $sql = mysqli_query($conn,"SELECT * from user WHERE level ='Admin' limit $awalData,$jumlahDataPerHalaman");
                                        }
