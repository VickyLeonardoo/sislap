<form method='POST' action="teruskan.php"></form>
                    <div class="row">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control form-control-user" id="judul"
                                                name="tgl_kejadian" readonly  value="<?php echo $data['tgl_pengaduan']; ?>">
                                        </div>
                                    <div class="form-group">
                                     ...
                                     <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control form-control-user" id="judul"
                                                name="tgl_kejadian" readonly value="<?php echo $data['tgl_kejadian']; ?>">
                                        </div>
                                        ...
                                        <label for="">Investigasi</label>
                                        <select class="form-control" name="inves">
...
<br>
                                        <div style="justify-content: center; align-items: center;" class="text-center">
                                            <input type="submit" value="Teruskan" name="" class="btn-primary"
